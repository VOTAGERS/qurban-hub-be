...
<body style="margin: 0; padding: 0; background-color: #7A1B2E; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
                    ...
                    <tr>
                        <td style="padding: 48px; text-align: center;">
                            ...
                            <div style="margin-bottom: 32px;">
                                <h2 style="color: #7A1B2E; font-size: 28px; margin: 0; font-weight: 700; letter-spacing: -0.5px;">Verifikasi Akun</h2>
                            </div>
                            ...
                            <!-- OTP Box -->
                            <div style="background-color: #fcf5f6; border: 1px solid #edf2f7; border-radius: 12px; padding: 24px; margin-bottom: 32px;">
                                ...
                                <div style="font-size: 36px; font-weight: 800; letter-spacing: 8px; color: #7A1B2E; font-family: 'Courier New', Courier, monospace;">
                                    {{ $otpCode }}
                                </div>
                            </div>
